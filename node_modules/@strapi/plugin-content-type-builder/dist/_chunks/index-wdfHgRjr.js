...
const index$1 = require("./index-TC6rOyqX.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-9unUR9BK.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-9unUR9BK.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-wdfHgRjr.js.map
