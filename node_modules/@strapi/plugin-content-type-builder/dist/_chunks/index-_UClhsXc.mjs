...
const ListView$1 = lazy(() => import("./ListView-chuCMWzR.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-chuCMWzR.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-_UClhsXc.mjs.map
