...
const useWebhooks = require("./useWebhooks-GXgjznJO.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-R1dGc0f2.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-NJUXeBbY.js.map
