...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-8K1fBeVH.mjs";
...
import { u as useWebhooks } from "./useWebhooks-iOOrR2-A.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-o63exNQr.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-QoGStdUX.mjs.map
