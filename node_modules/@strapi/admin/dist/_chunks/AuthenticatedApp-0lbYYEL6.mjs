...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-8K1fBeVH.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.18.0",
  "@strapi/permissions": "4.24.3",
  "@strapi/provider-audit-logs-local": "4.24.3",
  "@strapi/types": "4.24.3",
  "@strapi/typescript-utils": "4.24.3",
  "@strapi/utils": "4.24.3",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.24.3",
  "@strapi/data-transfer": "4.24.3",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.24.3",
...
const CM = React.lazy(
  () => import("./index-8K1fBeVH.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-7YZnnhqh.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-p1dCLD-H.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-fxKPePNY.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-8K1fBeVH.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage--TajCvU5.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-7hH4YDJD.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-0lbYYEL6.mjs.map
