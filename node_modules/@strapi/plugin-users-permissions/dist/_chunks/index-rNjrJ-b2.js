      ...
      [
        {
          ...
          async Component() {
            const component = await Promise.resolve().then(() => require("./index-St9neOIG.js"));
            return component;
          },
        ...
        },
        {
          ...
          async Component() {
            const component = await Promise.resolve().then(() => require("./index-GmZYWFzz.js"));
            return component;
          },
        ...
        },
        {
          ...
          async Component() {
            const component = await Promise.resolve().then(() => require("./index-MOwvg_G8.js"));
            return component;
          },
        ...
        },
        {
          ...
          async Component() {
            const component = await Promise.resolve().then(() => require("./index-P7a-wt4A.js"));
            return component;
          },
...
exports.index = index;
//# sourceMappingURL=index-rNjrJ-b2.js.map
