...
const dependencies = {
  ...
  "@strapi/icons": "1.18.0",
  "@strapi/provider-upload-local": "4.24.3",
  "@strapi/utils": "4.24.3",
  axios: "1.6.0",
  "byte-size": "7.0.1",
  cropperjs: "1.6.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-rA3mHrVR.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-xfK-7RJM.js"));
        return component;
      },
...
//# sourceMappingURL=index-LsxVVlH0.js.map
